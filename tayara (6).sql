...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 12 oct. 2020 à 21:05
...
CREATE TABLE IF NOT EXISTS `annonce` (
  ...
  `texte_annonce` longtext NOT NULL,
...
--
ALTER TABLE `annonce`
  ADD CONSTRAINT `fk_a_id_i` FOREIGN KEY (`a_id`) REFERENCES `users` (`id`);
...
ALTER TABLE `image_an`
  ADD CONSTRAINT `fk_i_id_id` FOREIGN KEY (`i_id`) REFERENCES `annonce` (`id`),
  ADD CONSTRAINT `fk_imahe_an_i_id` FOREIGN KEY (`i_id`) REFERENCES `annonce` (`id`) ON DELETE CASCADE;
COMMIT;
